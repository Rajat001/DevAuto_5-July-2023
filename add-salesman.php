...
<h4 class="card-title"> Add SalesPerson Staff </h4>
</div>
<div class="card-body ">
...
if(isset($_POST['add'])){
	...
	$a = "INSERT INTO salesman (`name`) VALUES ('$name')";
	$ad = mysqli_query($conn, $a);
	if($ad){
		echo "<script>  alert('Added Successfully') </script>";
		echo "<script> window.open('add-salesman.php','_self')</script>";
	}else{
