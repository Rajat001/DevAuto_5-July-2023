...
<div class="card-body ">
	...
	$deliveryKm =mysqli_real_escape_string($conn, $_POST['deliveryKm']);
		...
		<input  type="text" class="form-control" autocomplete="off" id="chasisNo" name="chasisNo" value="<?php echo $gate['chasisNo']; ?>" readonly style="font-weight: 900; color: crimson;"/  >
...
<br><br>
		...
		<div class="col-md-3">
		<div class="form-group">
<input type="text" id="receiptdata" name="receiptdata" value="<?php echo $gate['receiptNo']; ?>"  class="form-control" placeholder="Receipt No." readonly>
		</div>
		</div>
		<div class="col-md-3">
		<div class="form-group">
...
<input type="button" id="getreceipt" class="btn btn-info" value="View" placeholder=".col-md-5">
		...
		<div class="col-md-3">
		<div class="form-group">
<input type="text" id="receiptdatatwo" name="receiptdatatwo" value="<?php echo $gate['receiptNoOne']; ?>"   class="form-control" placeholder="Receipt No." readonly>
		</div> 
		</div>
		<div class="col-md-3">
		<div class="form-group">
...
<input type="button" id="getreceipttwo" class="btn btn-info" value="View" placeholder=".col-md-5">
		...
		<div class="col-md-3">
		<div class="form-group">
		<input type="text" id="receiptdatathree" name="receiptdatathree" class="form-control" value="<?php echo $gate['receiptNoTwo']; ?>" placeholder="Receipt No." readonly>
		</div>
		</div>
		<div class="col-md-3">
		<div class="form-group">
...
<input type="button" id="getreceiptthree" class="btn btn-info" value="View" placeholder=".col-md-5">
		...
		<div class="col-md-3">
		<div class="form-group">
<input type="text" id="receiptdatafour" value="<?php echo $gate['receiptNoThree']; ?>" name="receiptdatafour" class="form-control" placeholder="Receipt No." readonly>
		</div>
		</div>
		<div class="col-md-3">
		<div class="form-group">
...
<br>
		...
		<div class="col-md-3">
		<div class="form-group">
		<input type="text" id="receiptdatafive" name="receiptdatafive" class="form-control" value="<?php echo $gate['receiptNoFour']; ?>" placeholder="Receipt No." readonly>
		</div>
		</div>
		<div class="col-md-3">
		<div class="form-group">
	...
	<p id="receiptdetailfive" style="display: none; border: 1px; border-style: solid; color: #ff0080; text-align: center;"> 
		...
		<div class="col-md-3">
		<div class="form-group">
		<input type="text" id="receiptdatasix" name="receiptdatasix" class="form-control" value="<?php echo $gate['receiptNoFive']; ?>" placeholder="Receipt No." readonly>
		</div>
		</div>
		<div class="col-md-3">
		<div class="form-group">
...
<p id="receiptdetailsix" style="display: none; border: 1px; border-style: solid; color: #ff0080; text-align: center;"> 
		...
		<div class="col-md-3">
		<div class="form-group">
		<input type="text" id="receiptdataseven" name="receiptdataseven" class="form-control" value="<?php echo $gate['receiptNoSix']; ?>" placeholder="Receipt No." readonly>
		</div>
		</div>
		<div class="col-md-3">
		<div class="form-group">
...
<p id="receiptdetailseven" style="display: none; border: 1px; border-style: solid; color: #ff0080; text-align: center;"> 
		...
		<div class="col-md-3">
		<div class="form-group">
		<input type="text" id="receiptdataeight" name="receiptdataeight" class="form-control" value="<?php echo $gate['receiptNoSeven']; ?>" placeholder="Receipt No." readonly>
		</div>
		</div>
		<div class="col-md-3">
		<div class="form-group">
...
<p id="receiptdetaileight" style="display: none; border: 1px; border-style: solid; color: #ff0080; text-align: center;"> 
		...
		<div class="col-md-3">
		<div class="form-group">
		<input type="text" id="receiptdatanine" name="receiptdatanine" class="form-control" value="<?php echo $gate['receiptNoEight']; ?>" placeholder="Receipt No." readonly>
		</div>
		</div>
		<div class="col-md-3">
		<div class="form-group">
...
<p id="receiptdetailnine" style="display: none; border: 1px; border-style: solid; color: #ff0080; text-align: center;"> 
		...
		<textarea name="remark" id="cceditor2" rows="4" cols="50" readonly>
		...
		<input name="serviceBook" onkeypress="return ServiceBook(event)" type="text" class="form-control" value="<?php echo $gate['serviceBook'];?>"  autocomplete="off" style="font-weight: 900; color: crimson;" readonly>
		</div>	
<script type="text/javascript">
...
return true;
		...
		<input name="deliveryKm" onkeypress="return Deliverykm(event)" type="text" class="form-control" autocomplete="off" style="font-weight: 900; color: crimson;" value="<?php echo $gate['deliveryKm'];?>" readonly>
		</div>	
		<script type="text/javascript">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" style="font-weight: 900; color: crimson;" value="<?php echo $gate['paymentReceivable'];?>" name="paymentReceivable" id="paymentReceivable" onkeypress="return CostNumeric(event)" readonly>
		</div>
		...
		<div class="form-group">
			...
			<select id="idproofdocument" name="idproofdocument" class="form-control" disabled="">
		...
		<br>
		<img height="50" width="50" src="idproofdoc/<?php echo $gate['idProofdoc']; ?>">
		<br>
		</div>
		...
		<br>
		<img height="50" width="50" src="invoiceDoc/<?php echo $gate['invoiceDoc']; ?>">
		<br>
		</div>
		...
		<label id="font-color-label"> Upload Insurance  </label>
			...
			<br>
		<img height="50" width="50" src="insuranceDoc/<?php echo $gate['insuranceDoc']; ?>">
		<br>
		</div>
		...
		<br>
		<img height="50" width="50" src="rcDoc/<?php echo $gate['rcDoc']; ?>">
		<br>
		</div>
		...
		<textarea name="address" id="cceditor1" rows="4" cols="50"  readonly>
		...
		<textarea name="shortItem" id="cceditor" rows="4" cols="50" readonly="">
		...
		<select name="salesPerson" class="form-control" disabled="">
		<option value="">Select</option>
		<?php 
		...
		<select name="pD" class="form-control" disabled="">
		<option value="">Select</option>
		<?php 
		...
		<!-- Edit Section Starts-->
		<select id="accessorie_update" name="accessorie_update" disabled="">
		...
		//$s = "SELECT * FROM gatepassmgmt WHERE id = '".$_GET['id']."'";
