...
if(isset($_POST['add'])){
	...
	$a = "INSERT INTO paymode (`name`) VALUES ('$name')";
	$ad = mysqli_query($conn, $a);
	if($ad){
		echo "<script>  alert('Added Successfully') </script>";
		echo "<script> window.open('add-paymode.php','_self')</script>";
	}else{
...
<div class="row">
<label class="col-sm-2 control-label"><b> Payment Mode : </b></label>
<div class="col-sm-10">
