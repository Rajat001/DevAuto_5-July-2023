...
<h4 class="card-title">  View Cash Receipt </h4>
</div>
<div class="card-body ">
		...
		$up11 = "UPDATE receiptmgmt SET `date` ='$date',
				cusName ='$cusName',
				forName ='$forName',
				mobile ='$mobile',
		...
		<input type="date" id="challanDate" name="date" class="form-control" placeholder="Date Picker Here" value="<?php echo $cas['date']; ?>" readonly />
		</div>

		<div class="form-group" id="">
		<label id="font-color-label">Customer Name</label>
		<input id="cusName" name="cusName" type="text" placeholder="Enter Customer Name" value="<?php echo $cas['cusName']; ?>" class="form-control" readonly>
		</div>

		<div class="form-group">
		<label id="font-color-label"> For </label>
		<input id="forName" name="forName" type="text" placeholder="Enter Customer  For Name"  value="<?php echo $cas['forName']; ?>" class="form-control" readonly>
		</div>
		...
		<input id="mobile" name="mobile" type="text" placeholder="Enter Mobile No" class="form-control" onkeypress="return mobileNo(event)" value="<?php echo $cas['mobile']; ?>" readonly>
		</div>
		...
		<select id="financeMode" name="financeMode" class="selectpicker" data-title="Select" data-style="btn-default btn-outline" data-menu-style="dropdown-blue" disabled >
		...
		<input id="amtPaid" name="amtPaid" type="text" placeholder="Enter Amount" class="form-control" value="<?php echo $cas['amtPaid']; ?>" readonly>
		</div>
		...
		<select id="payVia" name="payVia" class="selectpicker" data-title="Select" data-style="btn-default btn-outline" data-menu-style="dropdown-blue" disabled>
		...
		$paymodename = mysqli_real_escape_string($sel_pay['name']);
		?>
		...
		<input type="date" id="cheqDate" name="cheqDate" class="form-control datepicker" value="<?php echo $cas['cheqDate']; ?>" readonly />
		</div>
		...
		<select id="exchange_veh_detail" name="exVehOpt" class="selectpicker" data-title="Select" data-style="btn-default btn-outline" data-menu-style="dropdown-blue" disabled>
		...
		<input type="text" id="exVehModel" name="exVehModel" class="form-control datepicker" placeholder="Enter Vehicle Model" value="<?php echo $cas['exVehModel'];?>" readonly />
		</div>
		
		<div class="form-group" >
		<label id="font-color-label"> Exchange Vehicle No. </label>		
		<input type="text" id="exVehNo" name="exVehNo" class="form-control datepicker" placeholder="Enter Vehicle No." value="<?php echo $cas['exVehNo'];?>" readonly />
		</div>

		<div class="form-group" >
		<label id="font-color-label"> Exchange Vehicle Amount </label>		
		<input type="text" id="exVehAmt" name="exVehAmt" class="form-control datepicker" placeholder="Enter Vehicle Amount" value="<?php echo $cas['exVehAmt'] ;?>" readonly />
		</div>
