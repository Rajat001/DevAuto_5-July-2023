...
<h4 class="card-title">Add Color Name </h4>
</div>
<div class="card-body ">
...
if(isset($_POST['add'])){
	...
	$a = "INSERT INTO modelcolor (`name`) VALUES ('$name')";
	$ad = mysqli_query($conn, $a);
	if($ad){
		echo "<script>  alert('Added Successfully') </script>";
		echo "<script> window.open('addModelColor.php','_self')</script>";
	}else{
...
<div class="row">
<label class="col-sm-2 control-label"><b> Add Color Name : </b></label>
<div class="col-sm-10">
